        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white shadow-lg rounded-lg dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <form @submit="submitProject" class="space-y-4" action="#">
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Project
                                Name</label>
                            <input @input="onChangeProjectName" :value="projectName"
                        ...
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Project
                                Comment</label>
                            <input @input="onchangeProjectDesc" :value="desc"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
...
export default {
    ...
    methods: {
        closeModal() {
            console.log("closeModal method is called!");
        ...
        async createProject() {
            try {
                const response = await services.createProject(this.projectName, this.desc);
