                ...
                <div class="max-w-md mx-auto">
                    ...
                    <div class="divide-y divide-gray-200">
                        <form @submit="handleSubmit"
                            ...
                            <div class="relative">
                                <input :value="username" @input="onchangeUsername" autocomplete="off" id="username"
                            ...
                            <div class="relative">
                                <input :value="password" @input="password" autocomplete="off" id="password" name="password"
                                    type="password"
                                    class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600"
                            ...
                            <div class="relative">
                                <button class="bg-pink-500 text-white rounded-md px-2 py-1">Login</button>
                            </div>
                        </form>
                    </div>
                </div>
