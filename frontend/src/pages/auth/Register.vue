        ...
        <div class="relative py-3 sm:max-w-xl sm:mx-auto">
            ...
            <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                <div class="max-w-md mx-auto">
                    <div>
                        <h1 class="text-4xl text-center font-semibold">Create Account
                        </h1>
                    </div>
                    <div class="divide-y divide-gray-200">
                        <form @submit="handleSubmit"
                            ...
                            <div class="text-center">
                                <button class="w-3/4 bg-blue-500 text-white rounded-md px-2 py-1">Register</button>
                            </div>
                            <div class="text-center">
                                <router-link class="text-sm text-teal-500 hover:text-teal-600" tag="a" to="/">Don't
                                    you have an
                                    account?</router-link>
                            </div>
                        </form>
